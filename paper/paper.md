...
We present an open-source course featuring a blend of lectures and practical sessions teaching how to set-up and analyse molecular dynamics (MD) simulations of biomolecules, with a particular focus on proteins. The material presented in this course has been delivered since 2022 to cohorts of 30-40 international postgraduates attending the UK-based CCP5 Summer School on Molecular simulation.
